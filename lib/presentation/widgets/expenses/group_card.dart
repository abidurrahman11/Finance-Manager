...
/// A tappable card representing a single [ExpenseGroupModel].
///
/// Shows title, description, date range (if set), type badge, and role.
/// Provides an optional delete action shown as a trailing icon button — only
/// supplied when the current user is the group owner.
class GroupCard extends StatelessWidget {
  ...
  String _dateRange(ExpenseGroupModel g) {
